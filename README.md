...
##Live Reload
One of my favorite things in the world (these days) is live reload. As you make edit files in the app directory, the changes will be pushed automatically to the browser through a web socket. It makes an old schooler like me smile every time.
